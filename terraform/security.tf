resource "aws_security_group" "alb" {
  name        = "${local.name}-alb"
  description = "Public ingress to DingoDocs ALB"
...
resource "aws_security_group" "tasks" {
  ...
  description = "DingoDocs Fargate web and migration tasks"
  vpc_id      = aws_vpc.this.id
...
resource "aws_security_group" "database" {
  ...
  description = "Private PostgreSQL access from DingoDocs tasks"
  vpc_id      = aws_vpc.this.id
